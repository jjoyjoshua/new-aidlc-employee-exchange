...
| **Traces to**   | REQ-004, REQ-018, REQ-019, REQ-022, NFR-004                                                                              |
...
Eight states. Draw the modal at **1280px** and the full-screen form at **360px** (NFR-004), including one 360px frame with the keyboard raised and the password checklist still visible — that constraint is why the checklist sits directly beneath the field rather than at the foot of the form. The `policy-checklist` component needs met and unmet variants that are legible without colour.
