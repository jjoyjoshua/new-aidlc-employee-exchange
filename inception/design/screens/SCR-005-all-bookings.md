...
| **Traces to**   | REQ-003, REQ-011, REQ-012, REQ-013, REQ-014, REQ-024, REQ-028, REQ-031, NFR-001, NFR-004, NFR-008                                                        |
...
| --- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | ---------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | The desk filter is not in REQ-012 or REQ-013, but BR-001.9's blocked-deactivation route needs it to be usable. Either the filter is accepted as within the spirit of REQ-011, or BR-001.9's flow needs its own requirement.                                                                                                  | REQ-011/012/013 vs BR-001.9        | PO/BA (`/ba`)    | **Resolved 2026-09-07 (Joy Joshua, PO/BA) — keep the filter.** BR-001.9's blocked-deactivation route is unusable without it. **`/ba` should widen REQ-011 (or REQ-012) to cover filtering by desk**, so the screen traces to a requirement rather than to this decision. **Codified 2026-09-10 as REQ-031** — given its own requirement rather than folded into REQ-011/REQ-012, so it can be scheduled and tested in its own right                                 |
