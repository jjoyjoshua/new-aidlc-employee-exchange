...
| FR-10  | `apps/ui/src/components/confirm-dialog/confirm-dialog.css`                                                        | overlay/card tokens, bottom-sheet breakpoint             | `ConfirmDialog.spec.tsx` (structural), verified against Figma frames          | implemented |
