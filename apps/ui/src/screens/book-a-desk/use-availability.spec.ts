...
const RESPONSE_A: AvailabilityResponse = { date: '2026-09-18', desks: [], myBooking: null, usualDeskId: null, nextFreeDays: [] };
const RESPONSE_B: AvailabilityResponse = { date: '2026-09-21', desks: [], myBooking: null, usualDeskId: null, nextFreeDays: [] };
