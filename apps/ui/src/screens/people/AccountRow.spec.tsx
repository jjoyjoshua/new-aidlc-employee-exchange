...
function renderTableRow(account: AdminUser, currentUserId = 'nobody') {
  return render(
    <table>
      <tbody>
        <AccountRow account={account} layout="table" currentUserId={currentUserId} onEdit={vi.fn()} onChangeRole={vi.fn()} onDeactivate={vi.fn()} onActivate={vi.fn()} />
      </tbody>
    </table>,
  );
}
...
function renderCardRow(account: AdminUser, currentUserId = 'nobody') {
  return render(
    <ul>
      <AccountRow account={account} layout="card" currentUserId={currentUserId} onEdit={vi.fn()} onChangeRole={vi.fn()} onDeactivate={vi.fn()} onActivate={vi.fn()} />
    </ul>,
  );
}
